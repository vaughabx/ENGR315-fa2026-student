...
### Print the standard deviations for each list ###
print("Standard deviation of list A:", std_A)
print("Standard deviation of list B:", std_B)
...
print("Largest standard deviation is in the list:", longest_list_is)